    ...
    <div class="testimonial-item-content <?php olympus_render( !isset( $avatar[ 0 ] ) ? esc_attr('no-avatar') : '' ); ?>">
        ...
        <?php if ( isset( $avatar[ 0 ] ) ) { ?>
            <div class="author-thumb">
                <img src="<?php echo esc_attr( $avatar[ 0 ] ); ?>" width="<?php echo esc_attr( $avatar_width ); ?>" height="<?php echo esc_attr( $avatar_height ); ?>" class="img-responsive" alt="<?php echo esc_attr( $name ); ?>" />
            </div>
        <?php } ?>
