    ...
    <div class="tribe-events-event-meta">
        <div class="author <?php echo esc_attr( $has_venue_address ); ?>">
            ...
            <div class="date-event inline-items align-left tribe-event-schedule-details">
                <svg class="olymp-small-calendar-icon"><use xlink:href="<?php echo get_template_directory_uri(); ?>/images/icons.svg#olymp-small-calendar-icon"></use></svg>
            ...
            <?php if ( $venue_details && !$empty_venue_address ) : ?>
                ...
                <div class="tribe-events-venue-details inline-items">
                    <svg class="olymp-small-calendar-icon"><use xlink:href="<?php echo get_template_directory_uri(); ?>/images/icons.svg#olymp-add-a-place-icon"></use></svg>
