...
if (olympus_akg('customize', $customize_content, 'no') === 'yes') {
    ...
    $menu_cart_icon = $olympus->get_option('menu_cart_icon', 'hide', $olympus::SOURCE_SETTINGS);
}
?>
...
<header class="header <?php echo (!is_user_logged_in()) ? 'header--logout' : ''; ?>" id="site-header">
    <div class="header-content-wrapper">
        <?php if (is_user_logged_in()) { ?>
            ...
            <a href="<?php echo get_post_permalink( 5, $leavename = false) ?>">
                <img class="img-fluid" width="70" src="https://bojelo.com/wp-content/uploads/2020/04/Bojelo-logo-512.png" alt="logo">
            </a>

        <?php } else { ?>

            <a href="<?php echo home_url('/'); ?>"  class="py-3 mx-3">
                <p class="text-white m-0" style="font-size: 2em">Bojelo</p>
            </a>

        <?php } ?>

        <?php if ($show_search === 'yes') { ?>
            <form id="top-search-form" action="<?php echo home_url('/'); ?>" method="GET"
                ...
                <div class="form-group with-button">
                    <div class="selectize-control form-control js-user-search multi">
                        <div class="selectize-input items not-full has-options">
                            <input type="text" autocomplete="off" name="s" id="s"
                                   value="<?php echo filter_input(INPUT_GET, 's'); ?>"
                                   placeholder="<?php esc_attr_e('Search here people or pages...', 'olympus'); ?>">
                        </div>
                    ...
                    <button>
                        ...
                        <svg class="olymp-search-spinner" width="135" height="135" viewBox="0 0 135 135"
        ...
        <nav class="primary-menu ml-5 navbarwhite">
            ...
            <?php if ($menu_cart_icon === 'show') { ?>
                <ul class="nav-add shoping-cart more text-white">
        ...
        <div class="fixed-sidebar right">
            <a href="#" class="side-menu-open js-sidebar-open">
                <i class="user-icon fas fa-bars" data-toggle="tooltip" data-placement="left"
                   data-original-title="<?php esc_attr_e('Ouvrir menu', 'olympus'); ?>"></i>
                <svg class="olymp-close-icon" data-toggle="tooltip" data-placement="left"
                     data-original-title="<?php esc_attr_e('Fermer menu', 'olympus'); ?>">
                    <use xlink:href="<?php echo get_template_directory_uri(); ?>/images/icons.svg#olymp-close-icon"></use>
                </svg>
            </a>
