...
if ( olympus_akg( 'customize', $single_post_elements, 'no' ) === 'yes' ) {
    ...
    $single_meta_show     = $olympus->get_option( 'single_meta_show', 'yes', $olympus::SOURCE_SETTINGS );
    $single_featured_show = $olympus->get_option( 'single_featured_show', 'yes', $olympus::SOURCE_SETTINGS );
    $single_share_show    = $olympus->get_option( 'single_share_show', 'yes', $olympus::SOURCE_SETTINGS );
    $single_related_show  = $olympus->get_option( 'single_related_show', $single_related_show_default, $olympus::SOURCE_SETTINGS );
    $single_reaction_show = $olympus->get_option( 'single_reaction_show', $single_reaction_show_default, $olympus::SOURCE_SETTINGS );
}
?>
                    ...
                    <div class="post-content-wrap">
                        <div class="reactions-cont-wrap smooth-scroll">
                            <a data-scroll href="<?php echo get_comments_link( get_the_ID() ); ?>" class=" post-add-icon post-comments-cont inline-items">
                                ...
                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="<?php echo get_template_directory_uri(); ?>/images/icons.svg#olymp-speech-balloon-icon"></use>
                                </svg>
