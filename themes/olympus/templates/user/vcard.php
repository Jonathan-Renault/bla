...
<div id="author-page" class="author-page author vcard inline-items">
    ...
    <div class="author-name fn more">
        <div class="author-title">
            <svg class="olymp-dropdown-arrow-icon"><use xlink:href="<?php echo get_template_directory_uri(); ?>/images/icons.svg#olymp-dropdown-arrow-icon"></use></svg>
        </div>
		...
		<div class="more-dropdown more-with-triangle">
			<div id="author-page-inner" class="mCustomScrollbar">
				...
				<div class="ui-block-title ui-block-title-small">
					<h6 class="title"><?php esc_html_e( 'Votre compte', 'olympus' ) ?></h6>
				</div>
