...
if ( function_exists( 'buddypress' ) ) {
	...
	?>
<!--    <div id="notifications-home" class="control-icon has-items">-->
<!--        <a style="margin-top: 18px" href="--><?php //echo esc_url(get_permalink(get_page_by_title('Actualite'))) ?><!--" class="icon-status-wrap">-->
<!--            <img class="olymp-home-icon" src="--><?php //echo get_template_directory_uri(); ?><!--/images/home.png" width="20" height="20"/>-->
<!--        </a>-->
<!--    </div>-->
