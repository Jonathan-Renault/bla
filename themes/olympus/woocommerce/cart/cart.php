					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                        ...
                        <td class="product-thumbnail" data-title="<?php esc_attr_e( 'Item Description', 'olympus' ); ?>">
                            ...
                            <div class="cart-product__item">
                                ...
                                <div class="cart-product-content">
									...
									if ( ! $product_permalink ) {
										echo olympus_html_tag('h6',array('class'=>'cartproduct-title'),apply_filters( 'woocommerce_cart_item_name', $_product->get_name(), $cart_item, $cart_item_key ));
									} else {
										echo apply_filters( 'woocommerce_cart_item_name', sprintf( '<a href="%s"  class="h6 cart-product-title">%s</a>', esc_url( $product_permalink ), $_product->get_name() ), $cart_item, $cart_item_key );
									}
                        ...
                        <td class="product-remove" data-title="<?php esc_attr_e( 'Remove', 'olympus' ); ?>">
							...
							echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
								...
								olympus_svg_icon('olymp-close-icon')
							), $cart_item_key );
							?>
                        </td>
                    </tr>
            ...
            <tr>
                <td colspan="4" class="actions">
                    ...
                    <div class="form-inline coupon">
                        ...
                        <button class="btn btn-primary btn-lg"><?php esc_attr_e( 'Apply', 'olympus' ); ?></button>
