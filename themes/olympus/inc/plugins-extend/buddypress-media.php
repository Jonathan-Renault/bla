		...
		<div class="photo-album-item create-album">
			...
			<div class="content">
				<span class="btn btn-control bg-primary">
					<svg class="olymp-plus-icon"><use xlink:href="<?php echo get_template_directory_uri(); ?>/images/icons.svg#olymp-plus-icon"></use></svg>
				</span>

				<span class="title h5"><?php echo esc_attr__( 'Create New Album', 'olympus' ); ?></span>
				<span class="sub-title"><?php echo esc_attr__( 'It only takes a few minutes!', 'olympus' ); ?></span>
			</div>
		</div>
	</li>
	<?php
