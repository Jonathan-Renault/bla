...
add_action( 'wp_enqueue_scripts', '_action_olympus_yz_scripts', 99 );
...
function _action_olympus_yz_scripts() {
	...
	if ( in_array( 'yz-account-css', $enqueued_styles ) ) {
		wp_enqueue_style( 'olympus-yz-account-css', get_theme_file_uri( 'css/youzer/yz-account-style.css' ), 'yz-account-css', $theme_version );
	}
