...
function _wpappninja_display_auto_page() {
	...
	if (isset($_POST['wpappninja_auto']) && check_admin_referer('wpappninjaauto')) {
        ...
        if (isset($_POST['wpappninja']['disable_all_cache'])) {
...
<div class="wpappninja-builder" <?php if (get_wpappninja_option('appify') != '1' && get_wpappninja_option('wpappninja_main_theme', 'WPMobile.App') != 'WPMobile.App') {echo ' style="display:block"';} ?>>
	...
	<div class="wpappninja-builder-right">
		...
		<select name="<?php echo WPAPPNINJA_SLUG;?>[cache_type]">
			...
			<option value="cacheonly" <?php if (get_wpappninja_option('cache_type', 'networkonly') == 'cacheonly'){echo 'selected';} ?>><?php _e('Agressive (not for ecommerce and social app)', 'wpappninja');?></option>

            <option value="networkonly" <?php if (get_wpappninja_option('cache_type', 'networkonly') == 'networkonly'){echo 'selected';} ?>><?php _e('Classic cache mode', 'wpappninja');?></option>
