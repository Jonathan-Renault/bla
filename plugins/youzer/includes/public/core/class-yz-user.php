...
class Youzer_User {
	...
	function cover( $query = null, $user_id = null ) {
		...
		// Print Cover.
		echo apply_filters( 'yz_user_profile_cover', $cover, $user_id );
	...
	function photo( $args = null ) {
		...
		// Link to option of Profile
        $profile_option1 = get_author_posts_url( $user_id );
        $profile_option2 = '/profile/change-avatar/';

		echo "<div class='$photo_class'>";
//        echo "<a href='$profile_url' class='yz-profile-img'>$avatar_img</a>";
        echo "<a href='$profile_option1$profile_option2' class='yz-profile-img'>$avatar_img</a>";
		echo "</div>";
	...
	function name( $user_id = null ) {
        ...
        $username2 = bp_get_user_firstname( $user_id );
...
//
//        echo "<div class='yz-name'>";
//        echo "<h2>". $last_name1 . " " . $first_name1 . "</h2>";
//        echo "</div>";
