...
<?php if ( class_exists( 'bbPress' ) && defined( 'BP_FORUMS_SLUG' ) ) { ?>
	<a href="<?php echo esc_url( bp_loggedin_user_domain() . BP_FORUMS_SLUG ); ?>" class="link-item">
		...
		<div class="title"><?php esc_html_e( 'Academy', 'crum-ext-sign-form' ); ?></div>
		<div class="sup-title"><?php esc_html_e( 'Commencer une nouvelle formation', 'crum-ext-sign-form' ); ?></div>
	</a>
<?php } ?>
<?php if ( bp_is_active( 'settings' ) ) { ?>
	<a href="<?php echo esc_url( bp_loggedin_user_domain() . bp_get_settings_slug() ); ?>" class="link-item">
		...
		<div class="title"><?php esc_html_e( 'Groupes & Forums', 'crum-ext-sign-form' ); ?></div>
		<div class="sup-title"><?php esc_html_e( 'Créer un groupe ou une nouvelle discussion', 'crum-ext-sign-form' ); ?></div>
	</a>
<?php } ?>