...
<!--					</svg>-->
			...
			<li class="nav-item">
				<a id="register-field" class="nav-link" data-toggle="tab" href="#register-panel-<?php echo esc_attr( $rand ); ?>"
				   role="tab">
...
<!--					</svg>-->
					<span><?php esc_html_e( 'S\'inscrire', 'crum-ext-sign-form' ); ?></span>
				</a>
			</li>
		</ul>
	<?php } ?>
    ...
    <div class="tab-content">
		...
		<?php if ( $can_register && ($forms === 'register' || $forms === 'both') ) { ?>
			<div class="tab-pane register-panel" id="register-panel-<?php echo esc_attr( $rand ); ?>" role="tabpanel">
				<?php
